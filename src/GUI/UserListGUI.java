...
//
    ...
    private void removeButnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Users userDel = usDao.getUserByID(id);
        if (usDao.deleteUser(userDel) == false) this.dispose();
        model.setRowCount(0);
        displayUsers();
    ...
    private void modifyButnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        int row = jTable1.getSelectedRow();
        String idS = jTable1.getModel().getValueAt(row, 0).toString();
        int id = Integer.valueOf(idS);
        userM.setId(id);
        userM.setName(jTable1.getModel().getValueAt(row, 1).toString());
        userM.setPassword(jTable1.getModel().getValueAt(row, 2).toString());
        userM.setRole(jTable1.getModel().getValueAt(row, 3).toString());
        usDao.modifyUser(userM);
        }
