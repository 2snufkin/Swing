...
public class ItemsDAO  implements IitemsDAO {
    ...
    public static final String QFINIDID = "SELECT "+ COLUMN_ITEMS_ID +" from " + TABLE_ITEMS + " where " + COLUMN_ITEMS_NAME + " = ?;";
    public static final String QFINDITEMBYID = "SELECT * from " + TABLE_ITEMS + " where " + COLUMN_ITEMS_ID + " = '";

    PreparedStatement  PSfindItem;
    PreparedStatement  PSfindItemID;
    ...
    public Items getItemByID(String id) {
        ...
        StringBuilder stb = new StringBuilder(QFINDITEMBYID);
        stb.append(id + "';");
        ...
        try {
            ...
            if (rs.next()) {
                u.setName(rs.getString(COLUMN_ITEMS_NAME));
                u.setPrice(rs.getDouble(COLUMN_ITEMS_PRICE));
    ...
    public int searchItemID(String name) {
        ...
        int returnInt = 0;
        try {
            System.out.println(QFINIDID);
            PSfindItemID = conn.prepareStatement(QFINIDID);
            PSfindItemID.setString(1, name);
            ResultSet rs = PSfindItemID.executeQuery();
            if (rs.next()) {
    ...
    public static void main(String[] args)  {
        ...
        int x = start.searchItemID("Banon");
